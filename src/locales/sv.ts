const sv = {
  ...
  label: {
    ...
    speedPrint: 'Utskrift',
    speedSlew: 'Frammatning',
    speedBackfeed: 'Återmatning',
    slewSpeed: 'Frammatningshastighet (ips, 2-14)',
    backfeedSpeed: 'Återmatningshastighet (ips, 2-14)',
    darkness: 'Svärta (-30 till +30)',
    darknessHint: 'Skrivarspecifik. Lämna tom för skrivarens standardvärde.',
    darknessHeading: 'Svärta',
    darknessPermanent: 'Permanent (-30..30)',
    darknessInstant: 'Direkt (0..30)',
    instantDarkness: 'Omedelbar svärta (0-30)',
    mediaType: 'Materialtyp',
    mediaTypeT: 'Termotransfer',
    mediaTypeD: 'Direkttermisk',
    printOrientation: 'Utskriftsorientering',
    printOrientationN: 'Normal',
    printOrientationI: 'Upp och ner (180°)',

const cs = {
  ...
  label: {
    ...
    speedHeading: 'Rychlost (ips, 2-14)',
    speedPrint: 'Tisk',
    speedSlew: 'Posuv',
    speedBackfeed: 'Zpětný posuv',
    slewSpeed: 'Rychlost posuvu (ips, 2-14)',
    backfeedSpeed: 'Rychlost zpětného posuvu (ips, 2-14)',
    darkness: 'Sytost tisku (-30 až +30)',
    darknessHint: 'Specifické pro tiskárnu. Ponechte prázdné pro výchozí hodnotu tiskárny.',
    darknessHeading: 'Sytost',
    darknessPermanent: 'Trvalé (-30..30)',
    darknessInstant: 'Okamžitě (0..30)',
    instantDarkness: 'Okamžitá sytost (0-30)',
    mediaType: 'Typ média',
    mediaTypeT: 'Termotransferový',
    mediaTypeD: 'Přímý termotisk',
    printOrientation: 'Orientace tisku',
    printOrientationN: 'Normální',
    printOrientationI: 'Vzhůru nohama (180°)',

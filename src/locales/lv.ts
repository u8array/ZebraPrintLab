const lv = {
  ...
  label: {
    ...
    speedHeading: 'Ātrums (ips, 2-14)',
    speedPrint: 'Druka',
    speedSlew: 'Pārvietošana',
    speedBackfeed: 'Atgaita',
    slewSpeed: 'Pārvietošanās ātrums (ips, 2-14)',
    backfeedSpeed: 'Atgaitas ātrums (ips, 2-14)',
    darkness: 'Tumšums (-30 līdz +30)',
    darknessHint: 'Atkarīgs no printera. Atstājiet tukšu, lai izmantotu noklusējumu.',
    instantDarkness: 'Tūlītēja tumšums (0-30)',
    darknessHeading: 'Tumšums',
    darknessPermanent: 'Pastāvīgi (-30..30)',
    darknessInstant: 'Tūlītēji (0..30)',
    mediaType: 'Materiāla veids',
    mediaTypeT: 'Termopārnese',
    mediaTypeD: 'Tiešais termālais',
    printOrientation: 'Drukāšanas orientācija',
    printOrientationN: 'Parasta',
    printOrientationI: 'Otrādi (180°)',

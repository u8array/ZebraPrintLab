const lt = {
  ...
  label: {
    ...
    speedHeading: 'Greitis (ips, 2-14)',
    speedPrint: 'Spausdinimas',
    speedSlew: 'Postūmis',
    speedBackfeed: 'Atgalinis postūmis',
    slewSpeed: 'Postūmio greitis (ips, 2-14)',
    backfeedSpeed: 'Atgalinio postūmio greitis (ips, 2-14)',
    darkness: 'Tamsumas (-30 iki +30)',
    darknessHint: 'Priklauso nuo spausdintuvo. Palikite tuščią numatytąjai reikšmei.',
    instantDarkness: 'Momentinis tamsumas (0-30)',
    darknessHeading: 'Tamsumas',
    darknessPermanent: 'Nuolatinis (-30..30)',
    darknessInstant: 'Momentinis (0..30)',
    mediaType: 'Laikmenos tipas',
    mediaTypeT: 'Šiluminis perdavimas',
    mediaTypeD: 'Tiesioginis terminis',
    printOrientation: 'Spausdinimo orientacija',
    printOrientationN: 'Įprasta',
    printOrientationI: 'Apsuktai (180°)',

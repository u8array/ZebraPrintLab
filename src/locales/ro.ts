const ro = {
  ...
  label: {
    ...
    speedHeading: 'Viteză (ips, 2-14)',
    speedPrint: 'Tipărire',
    speedSlew: 'Avansare',
    speedBackfeed: 'Retragere',
    slewSpeed: 'Viteză de avansare (ips, 2-14)',
    backfeedSpeed: 'Viteză de retragere (ips, 2-14)',
    darkness: 'Densitate imprimare (-30 până la +30)',
    darknessHint: 'Specific imprimantei. Lăsați gol pentru valoarea implicită.',
    darknessHeading: 'Întunecare',
    darknessPermanent: 'Permanent (-30..30)',
    darknessInstant: 'Imediat (0..30)',
    instantDarkness: 'Întunecare imediată (0-30)',
    mediaType: 'Tip mediu',
    mediaTypeT: 'Transfer termic',
    mediaTypeD: 'Termic direct',
    printOrientation: 'Orientare imprimare',
    printOrientationN: 'Normal',
    printOrientationI: 'Cu susul în jos (180°)',

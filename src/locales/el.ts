const el = {
  ...
  fonts: {
    ...
    embedInZpl: 'Αποστολή με ZPL',
    embedInZplHint: 'Εκπέμπει ~DY ώστε ο εκτυπωτής (και η Labelary) να λάβουν αυτήν τη γραμματοσειρά μαζί με την ετικέτα. Απαιτεί ψευδώνυμο.',
    ...
    builtinPreviewsTeaser: 'Θέλετε να δείτε πώς εμφανίζονται οι ενσωματωμένες γραμματοσειρές; Δείτε την ενότητα παρακάτω.',

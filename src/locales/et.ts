const et = {
  ...
  label: {
    ...
    speedHeading: 'Kiirus (ips, 2-14)',
    speedPrint: 'Trükk',
    speedSlew: 'Edasiliikumine',
    speedBackfeed: 'Tagasiliikumine',
    slewSpeed: 'Edasiliikumiskiirus (ips, 2-14)',
    backfeedSpeed: 'Tagasiliikumiskiirus (ips, 2-14)',
    darkness: 'Tumedus (-30 kuni +30)',
    darknessHint: 'Printerispetsiifiline. Vaikeväärtuse kasutamiseks jäta tühjaks.',
    instantDarkness: 'Kohene tumedus (0-30)',
    darknessHeading: 'Tumedus',
    darknessPermanent: 'Püsiv (-30..30)',
    darknessInstant: 'Kohene (0..30)',
    mediaType: 'Meedialiik',
    mediaTypeT: 'Termoülekanne',
    mediaTypeD: 'Otsetermaal',
    printOrientation: 'Trükisuund',

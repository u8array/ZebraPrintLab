const tr = {
  ...
  label: {
    ...
    speedHeading: 'Hız (ips, 2-14)',
    speedPrint: 'Baskı',
    speedSlew: 'İlerletme',
    speedBackfeed: 'Geri besleme',
    slewSpeed: 'İlerletme hızı (ips, 2-14)',
    backfeedSpeed: 'Geri besleme hızı (ips, 2-14)',
    darkness: 'Koyuluk (-30 ile +30 arası)',
    darknessHint: 'Yazıcıya özel. Varsayılan için boş bırakın.',
    instantDarkness: 'Anlık koyuluk (0-30)',
    darknessHeading: 'Koyuluk',
    darknessPermanent: 'Kalıcı (-30..30)',
    darknessInstant: 'Anlık (0..30)',
